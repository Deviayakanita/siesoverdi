            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <div>
                        ...
                        <a href="/mutasikeluar/export" id="cetak" class="btn btn-danger" style="margin-left:617px; margin-right: 0px;" target="_blank"><i class="fa fa-file-pdf-o"></i> Export PDF</a>
                    </div>
                </div>
