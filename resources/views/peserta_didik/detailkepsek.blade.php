...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="/ctk_pesertadidik"></i>Daftar Peserta Didik</a></li>
...
<section class="content">
	<div class="box box-primary">
      ...
      <div align="right">
        <a href="/ctk_pesertadidik" class="btn btn-default btn-sm"><i class="fa fa-long-arrow-left"></i></a>
      </div>
      </div>
    </div>
